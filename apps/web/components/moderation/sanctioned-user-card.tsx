...
import { IconBan, IconExternalLink, IconLockOpen } from "@tabler/icons-react"
import { Button } from "../ui/button"
import { banUser, SanctionedUser, unbanUser } from "@/lib/actions/users"
...
export default function SanctionedUserCard({
  user,
  sanction,
  isAdmin,
  isPending,
