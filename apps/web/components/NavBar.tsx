  ...
  return (
    <nav className='grid h-12 w-screen grid-cols-5 border-t'>
      <a href='/home' className='flex w-full items-center justify-center'>
        {active("/home") ? (
          <IconHomeFilled size={30} className='text-foreground' />
        ) : (
          <IconHome size={30} className='text-muted-foreground' />
        )}
      </a>
      ...
      <a href='/messages' className='flex w-full items-center justify-center'>
        {active("/messages") ? (
          ...
          <IconMessageCircle size={30} className='text-muted-foreground' />
        )}
      </a>
      <a href='/profile' className='flex w-full items-center justify-center'>
        {active("/profile") ? (
          <IconUserFilled size={30} className='text-foreground' />
        ) : (
          <IconUser size={30} className='text-muted-foreground' />
        )}
      </a>
    </nav>
  )
